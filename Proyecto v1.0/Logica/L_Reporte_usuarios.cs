...
namespace Logica
{
    public class L_Reporte_usuarios
    {
        ...
        public Data_Reportes ObtenerInforme()
        {
            ...
            List<AulaWebContext_public.SpReporteUsuarioResult> datos2 = operacion.SpReporteUsuario().ToList<AulaWebContext_public.SpReporteUsuarioResult>();
            ...
            for (int i = 0; i < Intermedio.Rows.Count; i++)
            {
                ...
                fila["id_rol"] = Intermedio.Rows[i]["IdRol"].ToString();
