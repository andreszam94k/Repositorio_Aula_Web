...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h1 style="color: #CCCCCC">Formulario moderar archivos</h1>
    <h2 style="color: #CCCCCC; text-align: center;">archivos subidos</h2>
<h2 style="color: #CCCCCC; text-align: left;">¿Desea ver las categorias?&nbsp;
